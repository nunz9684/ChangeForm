...
<?php
	...
	$sql_update_parent = "update parent set ";
	$sql_update_parent.= "PR_FName='".$PR_FName."',PR_LName='".$PR_LName."',";
	$sql_update_parent.= "PR_State='".$PR_State."',PR_City='".$PR_City."',";
	$sql_update_parent.= "PR_Street='".$PR_Street."',PR_Zip='".$PR_Zip."'";
	$sql_update_parent.= " where PR_ID='".$PR_ID."';";
	echo "Parent Updated.";
	$result_insert_player=mysql_query($sql_update_parent);
?>
<center>
